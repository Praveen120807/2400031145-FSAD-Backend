...
public class CertificateController 
{
    ...
    public ResponseEntity<?> viewCertificates(@PathVariable int userid)
    {
        ...
        {
            return ResponseEntity.status(500).body("Error Fetching Certificates: " + e.getMessage());
        }
    }
            ...
            @PathVariable int userid)
    {
        ...
        {
            return ResponseEntity.status(500).body("Error Deleting Certificate: " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<byte[]> displayCertificate(@RequestParam int id) throws Exception
    {
        ...
        if(cert == null || cert.getFileData() == null)
        {
